...
if(isset($_POST['submit'])){
    ...
    if(array_filter($errors)){
		...
		$sql="INSERT INTO placement_details(company_name,contact_person,contact,address,remarks,applicable_departments,email,dat) VALUES('$company_name','$contact_person','$contact','$address','$remarks','$applicable_departments','$email','$date')";
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div class="row register-form">
                                    <div class="col-md-8">
                                        ...
                                        <?php echo $errors['contact_person']; ?>
                                         <div class="form-group">
