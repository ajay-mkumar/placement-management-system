...
if(isset($_POST['submit'])){
    ...
    if(array_filter($errors)){
		...
		$sql="UPDATE placement_details SET company_name='$company_name',contact_person='$contact_person',contact='$contact',address='$address',remarks='$remarks',applicable_departments='$applicable_departments',email='$email' WHERE id='$id'";
...
<?php if($count==1): 
    include('header.php')?>
        <span><a href="view_placement.php" class="text-dark">Back</a></span>
    </div>
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div class="row register-form">
                                    <div class="col-md-8">
	                                    ...
	                                    <input type="submit" class="btnRegister" name="submit"  value="update company"/>
                                         </div>
                                     <?php endforeach; ?>
                                     </div>
                                 </div>
