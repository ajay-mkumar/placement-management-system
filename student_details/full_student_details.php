...
<div class="container-xl">
  ...
  <div class="dropdown-menu">
	...
	<tbody>
		...
		<tr id="<?php echo $detail['id']; ?>">
		    ...
		    <td><?php echo $detail['cgpa']; ?></td>
              ...
              <form method="POST" action="update.php">
                ...
                <button type="submit" name="update" style="border: none;color: yellow;"><i class="material-icons" data-toggle="tooltip" title="Edit"></i></button>
              </form>
		...
		<td><button class="btn btn-success" onclick="showData(<?php echo $detail['id']; ?>)">View More</button></td>
...
$(document).ready(function(){
      ...
      $.ajax({    
        ...
        success: function(data){                    
           ...
           var myw= window.open("", "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,top=500,left=500,width=800,height=400");
           myw.document.write(data);
        }
    });
});
    }
