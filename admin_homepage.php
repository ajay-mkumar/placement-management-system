        ...
        <div class="main_nav">
          <ul class="main_nav_list">
           <li class="main_nav_item"><a href="admin_homepage.php">home</a></li>
            ...
            <li class="main_nav_item"><a href="http://localhost:5000/"> placement predict</a></li>
    ...
    <div class="menu_inner menu_mm">
      <div class="menu menu_mm">
        <ul class="menu_list menu_mm">
          <li class="menu_item menu_mm"><a href="admin_homepage.php">Home</a></li>
          <li class="menu_item menu_mm"><a href="placement_details/scrolling_details.php">Scrolling details</a></li>
          <li class="menu_item menu_mm"><a href=""> Hello <?php echo $name; ?></a></li>
        
          <li class="menu_item menu_mm"><a href="logout.phps">logout</a></li>
        </ul>
