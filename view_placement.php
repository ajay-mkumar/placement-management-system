  ...
  <div class="dropdown-menu">
    ...
    <a class="dropdown-item" onclick="sortTable(2)">Date</a>
            ...
            <!-- <a href="add_training_details1.php" class="btn btn-success" data-toggle="modal"><i class="material-icons"></i> <span>Add New Training</span></a> -->
                     <a href="add_placement_details.php" class="btn btn-success"> add new placement </a> 
          </div>
        </div>
      </div>
          ...
          if($date==$detail['dat']): ?> 
			...
			<td><?php echo $detail['email']; ?></td>
						<td class="text-center">
							...
							<button type="submit" name="update" style="border: none"><img src="images/update_icon.jpg" style="width: 20%" data-bs-toggle="tooltip" data-bs-placement="top" title="update"></button></form>
			...
			<form action="job_details.php" method="POST">
				<input type="hidden" name="id" value="<?php echo $detail['id']; ?>">
				<button type="submit" name="add" style="border: none;"><i class="material-icons" data-toggle="tooltip" title="add jobs">add</i></button>
			</form>

			 <form action="view_details.php" method="POST"> 
				<input type="hidden" name="view_id" value="<?php echo $detail['id']; ?>">
				<button type="submit" name="view_details" style="border:  none;"><i class="fa fa-eye" style="font-size:20px" data-toggle="tooltip" title="view jobs details"></i></button></form></td>
					</tr>
