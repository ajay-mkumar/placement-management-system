                    ...
                    <div class="col-md-9 register-right">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <h3 class="register-heading">Add Training Details</h3>
                                <div class="row register-form">
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <input type="text" class="form-control"  name="resource_person" placeholder="contact person" value="<?php echo $resorce_person; ?>" />
                                        </div>

                                         <div class="form-group">
                                            <input type="date" name="date" class="form-control" placeholder="date" value="<?php echo $dob; ?>" />
                                        </div>
                                         <div class="form-group">
